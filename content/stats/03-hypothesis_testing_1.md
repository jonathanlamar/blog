...
2. The _Type I Error_ associated to $\psi_n$ is
   ...
   $$
   \alpha*{\psi_n}(\theta) = \mathbb{P}*\theta(\psi_n(X_1, X_2, \ldots, X_n)
   = 1 \mid \theta\in\Theta_0).
   $$
...
3. The _Type II Error_ associated to $\psi_n$ is
   ...
   $$
   \beta*{\psi_n}(\theta) = \mathbb{P}*\theta(\psi_n(X_1, X_2, \ldots, X_n)
   = 0 \mid \theta\in\Theta_1).
   $$
...
1. An important point about hypothesis testing: While we always want to strike a
   ...
   $$
   \alpha := \sup\{\alpha*\psi(\theta) \mid \theta\in \Theta_0\}.
   $$
...
2. Often, we will not understand the distribution of our test statistic
   ...
   $$
   \alpha := \limsup_{n\to\infty}\sup\{\alpha*{\psi_n}(\theta) \mid \theta\in \Theta_0\}.
   $$
